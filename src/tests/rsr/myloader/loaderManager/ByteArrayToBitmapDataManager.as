package tests.rsr.myloader.loaderManager
{
	...
	{
		private static const N_MAX_LOADING:int = 1;
		...
		public function loadBitmapData(bytes:ByteArray, receiver:IByteArrayToBitmapDataManagerReceiver):void
		{
...
class BitmapDataLoader
{
	...
	private function completeHandle(event:Event):void
	{
		...
		if (bitmap)
		{
			_receiver.bitmapDataReceive(_bytes, bitmap.bitmapData);
		}
		else
		{
